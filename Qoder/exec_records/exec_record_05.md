...
```bash
mkdir -p /home/wsy/qoder/code_eval
```
...
```bash
cd /home/wsy/qoder/code_eval && python3 score_report.py
```
...
| 文件 | 操作 |
|------|------|
| `/home/wsy/qoder/code_eval/scores.csv` | 新建 |
| `/home/wsy/qoder/code_eval/score_report.py` | 新建 + 修改 |
| `/home/wsy/qoder/code_eval/repair_report.md` | 新建 |

### 执行的命令

1. `mkdir -p /home/wsy/qoder/code_eval`
